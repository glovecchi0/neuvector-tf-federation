...
module "aws_elastic_kubernetes_service" {
  source                = "git::https://github.com/glovecchi0/neuvector-tf.git//tf-modules/aws/eks"
  prefix                = var.prefix
...
resource "local_file" "kube_config_yaml" {
  ...
  content = templatefile("./kubeconfig.yml.tmpl", {
...
data "kubernetes_service" "neuvector_svc_controller_fed_managed" {
  metadata {
...
data "kubernetes_service" "neuvector_svc_controller_fed_master" {
  metadata {
